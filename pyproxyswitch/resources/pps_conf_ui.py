...
class Ui_Dialog_Config(object):
    def setupUi(self, Dialog_Config):
        ...
        self.label_localport.setGeometry(QRect(20, 60, 81, 20))
        self.le_localport = QLineEdit(self.tab_advanced)
        self.le_localport.setObjectName(u"le_localport")
        self.le_localport.setGeometry(QRect(100, 60, 61, 20))
        ...
        self.label_debug.setGeometry(QRect(20, 140, 71, 20))
        self.checkBox_debug = QCheckBox(self.tab_advanced)
        self.checkBox_debug.setObjectName(u"checkBox_debug")
        self.checkBox_debug.setGeometry(QRect(100, 140, 251, 21))
        ...
        QWidget.setTabOrder(self.comboBox_lang, self.le_localport)
