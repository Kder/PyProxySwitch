...
class Ui_Dialog_Config(object):
    ...
    def retranslateUi(self, Dialog_Config):
        ...
        self.label_cmd.setText(QCoreApplication.translate("Dialog_Config", u"Proxy Core", None))
        self.comboBox_cmd.setItemText(0, QCoreApplication.translate("Dialog_Config", u"internal", None))
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog_Config", u"Built-in HTTP/SOCKS proxy (no external process)", None))
